...
export class RcRuntimeMetadataService extends AbstractService {
	/**
	 * Fetch `Metadata` from the relay chain in decoded JSON form.
	 *
	 * @param hash `BlockHash` to make call at
	 * @param api Relay chain API instance.
	 */
	async fetchMetadata(hash: BlockHash, api: ApiPromise): Promise<Metadata> {
	...
	/**
	 * Fetch the requested version of `Metadata` from the relay chain in decoded JSON form.
	 *
	 * @param apiAt Historic API instance for the relay chain.
	 * @param metadataVersion Version of metadata to fetch.
	 */
	...
	/**
	 * Fetch the available `Metadata` versions from the relay chain.
	 *
	 * @param hash `BlockHash` to make call at
	 * @param api Relay chain API instance.
	 */
	async fetchMetadataVersions(hash: BlockHash, api: ApiPromise): Promise<string[]> {
