...
const accountsBalanceInfoService = new RcAccountsBalanceInfoService('mock');
...
describe('AccountsBalanceInfoService', () => {
	...
	describe('fetchAccountBalanceInfo', () => {
		it('works when ApiPromise works (block 789629)', async () => {
			...
			const tempAccountsBalanceInfoService = new RcAccountsBalanceInfoService('mock');
		...
		it('works when the api does not have the frozen field in Account data', async () => {
			...
			const tmpAccountsBalanceInfoService = new RcAccountsBalanceInfoService('mock');
		...
		describe('token recognition', () => {
			...
			const tokenAccountsBalanceInfoService = new RcAccountsBalanceInfoService('mock');
