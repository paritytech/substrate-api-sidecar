...
export const assetHubWestendGetBlock = (
	_hash: Hash
): Promise<{ block: Block }> =>
	Promise.resolve().then(() => {
		return {
...
export const assetHubWestendDeriveGetBlock = (
	_hash: Hash
): Promise<{ block: Block; author: AccountId }> =>
	Promise.resolve().then(() => {
		return {
			author: assetHubWestendRegistryV9435.createType('AccountId', [
...
const getHeader = (_hash: Hash) =>
	Promise.resolve().then(() => mockBlock5236177.header);
...
export const assetHubWestendActiveEraAt = (
	_hash: Hash
): Promise<Option<ActiveEraInfo>> =>
	Promise.resolve().then(() =>
		assetHubWestendRegistryV9435.createType('Option<ActiveEraInfo>', [
			{ index: 49 },
			{ start: 1595259378000 },
		])
	);
...
export const assetHubWestendErasStartSessionIndexAt = (
	...
	Promise.resolve().then(() =>
		assetHubWestendRegistryV9435.createType('Option<SessionIndex>', [330])
	);

export const assetHubWestendBondedAt = (
	_hash: Hash,
	_address: string
): Promise<Option<AccountId>> =>
	Promise.resolve().then(() =>
		assetHubWestendRegistryV9435.createType('Option<AccountId>', [
			testAddressController,
		])
	);

export const assetHubWestendLedgerAt = (
	_hash: Hash,
	_address: string
...
const queryFeeDetails = () =>
	Promise.resolve().then(() => {
		const inclusionFee = assetHubWestendRegistryV9435.createType(
			'Option<InclusionFee>',
			[
				{
					baseFee: 10000000,
...
const runtimeDispatchInfo = assetHubWestendRegistryV9435.createType(
	'RuntimeDispatchInfo',
	{
		weight: {
			refTime: 125000000,
...
export const assetHubWestendQueryInfoAt = (
	_extrinsic: string,
	_hash: Hash
): Promise<RuntimeDispatchInfo> =>
	Promise.resolve().then(() => runtimeDispatchInfo);

export const assetHubWestendSubmitExtrinsic = (
	_extrinsic: string
): Promise<Hash> =>
	Promise.resolve().then(() =>
		assetHubWestendRegistryV9435.createType('Hash', [])
	);

const getStorage = () =>
	Promise.resolve().then(() =>
		assetHubWestendRegistryV9435.createType('Option<Raw>', ['0x00'])
	);
...
const health = () =>
	Promise.resolve().then(() =>
		assetHubWestendRegistryV9435.createType('Health', [
			'0x7a000000000000000001',
		])
	);

const localListenAddresses = () =>
	Promise.resolve().then(() =>
		assetHubWestendRegistryV9435.createType('Vec<Text>', [
			localListenAddressesHex,
		])
	);

const nodeRoles = () =>
	Promise.resolve().then(() =>
		assetHubWestendRegistryV9435.createType('Vec<NodeRole>', ['0x0400'])
	);
...
export const assetHubWestendPendingExtrinsics = (): Promise<Vec<Extrinsic>> =>
	Promise.resolve().then(() =>
		assetHubWestendRegistryV9435.createType('Vec<Extrinsic>', [])
	);
...
export const mockAssetHubWestendApi = {
	...
	createType: assetHubWestendRegistryV9435.createType.bind(
		assetHubWestendRegistryV9435
	),
