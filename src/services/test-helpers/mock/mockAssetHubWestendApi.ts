...
export const assetHubWestendDeriveGetBlock = (
	...
	Promise.resolve().then(() => {
		return {
			author: assetHubWestendRegistryV9435.createType(
				'AccountId',
...
const version = () =>
	Promise.resolve().then(() =>
		assetHubWestendRegistryV9435.createType(
			'Text',
...
const health = () =>
	Promise.resolve().then(() =>
		assetHubWestendRegistryV9435.createType('Health', ['0x7a000000000000000001'])
	);

const localListenAddresses = () =>
	Promise.resolve().then(() =>
		assetHubWestendRegistryV9435.createType('Vec<Text>', [localListenAddressesHex])
	);
