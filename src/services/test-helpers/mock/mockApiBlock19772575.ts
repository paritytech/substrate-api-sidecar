...
import { balancesTransferValid, blockHash19772575, mockBlock19772575, testAddressController } from '.';
...
export const getBlockXCM19772575 = (_hash: Hash): Promise<{ block: Block }> =>
	Promise.resolve().then(() => {
		return {
			block: mockBlock19772575,
		};
	});

export const deriveGetBlockXCM19772575 = (_hash: Hash): Promise<{ block: Block; author: AccountId }> =>
	Promise.resolve().then(() => {
		return {
...
const getHeader = (_hash: Hash) => Promise.resolve().then(() => mockBlock19772575.header);
...
export const activeEraAtXCM19772575 = (_hash: Hash): Promise<Option<ActiveEraInfo>> =>
	Promise.resolve().then(() =>
...
export const erasStartSessionIndexAtXCM19772575 = (_hash: Hash, _activeEra: EraIndex): Promise<Option<SessionIndex>> =>
	Promise.resolve().then(() => polkadotRegistryV1000001.createType('Option<SessionIndex>', 330));

export const bondedAtXCM19772575 = (_hash: Hash, _address: string): Promise<Option<AccountId>> =>
	Promise.resolve().then(() => polkadotRegistryV1000001.createType('Option<AccountId>', testAddressController));

export const ledgerAtXCM19772575 = (_hash: Hash, _address: string): Promise<Option<StakingLedger>> =>
	Promise.resolve().then(() =>
...
export const queryInfoCallXCM19772575 = (
	_extrinsic: GenericExtrinsic,
	_length: Uint8Array,
): Promise<RuntimeDispatchInfo> => Promise.resolve().then(() => runtimeDispatchInfo);

export const queryInfoAtXCM19772575 = (_extrinsic: string, _hash: Hash): Promise<RuntimeDispatchInfo> =>
	Promise.resolve().then(() => runtimeDispatchInfo);

export const submitExtrinsicXCM19772575 = (_extrinsic: string): Promise<Hash> =>
...
const getFinalizedHead = () => Promise.resolve().then(() => blockHash19772575);
...
export const pendingExtrinsicsXCM19772575 = (): Promise<Vec<Extrinsic>> =>
	Promise.resolve().then(() => polkadotRegistryV1000001.createType('Vec<Extrinsic>'));

export const txXCM19772575 = (): Extrinsic => polkadotRegistryV1000001.createType('Extrinsic', balancesTransferValid);
 ...
 */
export const mockApiBlock19772575 = {
	runtimeVersion,
	call: {
		transactionPaymentApi: {
			queryInfo: queryInfoCallXCM19772575,
			queryFeeDetails,
		},
	},
	consts: {
	...
	rpc: {
		...
		payment: {
			queryInfo: queryInfoAtXCM19772575,
			queryFeeDetails,
		},
		author: {
			submitExtrinsicXCM19772575,
			pendingExtrinsicsXCM19772575,
		},
	},
	derive: {
		chain: {
			getHeader: deriveGetHeader,
			getBlock: deriveGetBlockXCM19772575,
		},
	},
	query: {
		nominationPools: {
