...
const chain = () =>
	Promise.resolve().then(() => {
		return assetHubKusamaRegistryV9430.createType('Text', 'Kusama');
	});

export const assetHubKusamaGetBlock = (
	_hash: Hash
): Promise<{ block: Block }> =>
	Promise.resolve().then(() => {
		return {
...
export const assetHubKusamaDeriveGetBlock = (
	_hash: Hash
): Promise<{ block: Block; author: AccountId }> =>
	Promise.resolve().then(() => {
		return {
			author: assetHubKusamaRegistryV9430.createType(
				'AccountId',
...
const getHeader = (_hash: Hash) =>
	Promise.resolve().then(() => mockBlock523510.header);

const runtimeVersion = {
	specName: assetHubKusamaRegistryV9430.createType('Text', 'kusama'),
...
const version = () =>
	Promise.resolve().then(() =>
		assetHubKusamaRegistryV9430.createType(
			'Text',
			'0.8.22-c6ee8675-x86_64-linux-gnu'
		)
	);

export const assetHubKusamaActiveEraAt = (
	_hash: Hash
): Promise<Option<ActiveEraInfo>> =>
	Promise.resolve().then(() =>
...
export const assetHubKusamaErasStartSessionIndexAt = (
	...
	Promise.resolve().then(() =>
		assetHubKusamaRegistryV9430.createType('Option<SessionIndex>', 330)
	);

export const assetHubKusamaBondedAt = (
	_hash: Hash,
	_address: string
...
export const assetHubKusamaLedgerAt = (
	_hash: Hash,
	_address: string
...
const queryFeeDetails = () =>
	Promise.resolve().then(() => {
		const inclusionFee = assetHubKusamaRegistryV9430.createType(
			'Option<InclusionFee>',
			{
				baseFee: 10000000,
				lenFee: 143000000,
...
const runtimeDispatchInfoV2 = assetHubKusamaRegistryV9430.createType(
	'RuntimeDispatchInfoV2',
	{
		weight: {
			refTime: 1200000000,
...
export const assetHubKusamaQueryInfoCall = (
	...
	_length: Uint8Array
): Promise<RuntimeDispatchInfoV2> =>
	Promise.resolve().then(() => runtimeDispatchInfoV2);

export const assetHubKusamaQueryInfoAt = (
	_extrinsic: string,
	_hash: Hash
): Promise<RuntimeDispatchInfoV2> =>
	Promise.resolve().then(() => runtimeDispatchInfoV2);

export const assetHubKusamaSubmitExtrinsic = (
	_extrinsic: string
): Promise<Hash> =>
...
const getStorage = () =>
	Promise.resolve().then(() =>
		assetHubKusamaRegistryV9430.createType('Option<Raw>', '0x00')
	);
...
const health = () =>
	Promise.resolve().then(() =>
		assetHubKusamaRegistryV9430.createType('Health', '0x7a000000000000000001')
	);

const localListenAddresses = () =>
	Promise.resolve().then(() =>
		assetHubKusamaRegistryV9430.createType('Vec<Text>', localListenAddressesHex)
	);

const nodeRoles = () =>
	Promise.resolve().then(() =>
		assetHubKusamaRegistryV9430.createType('Vec<NodeRole>', '0x0400')
	);
...
export const assetHubKusamaPendingExtrinsics = (): Promise<Vec<Extrinsic>> =>
	Promise.resolve().then(() =>
		assetHubKusamaRegistryV9430.createType('Vec<Extrinsic>')
	);
...
export const mockAssetHubKusamaApi = {
	...
	createType: assetHubKusamaRegistryV9430.createType.bind(
		assetHubKusamaRegistryV9430
	),
