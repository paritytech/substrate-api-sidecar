...
import { kusamaMetadataV1003003M } from '../../../test-helpers/metadata/metadata';
...
export const deriveGetBlock26187139 = (_hash: Hash): Promise<{ block: Block; author: AccountId }> =>
	Promise.resolve().then(() => {
		return {
			author: kusamaRegistryV1003003.createType('AccountId', '1zugcajGg5yDD9TEqKKzGx7iKuGWZMkRbYcyaFnaUaEkwMK'),
			block: mockBlock26187139,
		};
	});
...
const runtimeVersion = {
	specName: kusamaRegistryV1003003.createType('Text', 'kusama'),
	specVersion: kusamaRegistryV1003003.createType('u32', 1003003),
	transactionVersion: kusamaRegistryV1003003.createType('u32', 26),
	implVersion: kusamaRegistryV1003003.createType('u32', 0),
	implName: kusamaRegistryV1003003.createType('Text', 'parity-kusama'),
	authoringVersion: kusamaRegistryV1003003.createType('u32', 2),
};
...
const getMetadata = () => Promise.resolve().then(() => kusamaMetadataV1003003M);

// For getting the blockhash of the genesis block
const getBlockHashGenesis = (_zero: number) =>
	Promise.resolve().then(() =>
		kusamaRegistryV1003003.createType(
			'BlockHash',
			'0x91b171bb158e2d3848fa23a9f1c25182fb8e20313b2c1eb49219da7a70ce90c3',
		),
	);

const runtimeDispatchInfo = kusamaRegistryV1003003.createType('RuntimeDispatchInfo', {
	weight: {
		refTime: '145570000',
		proofSize: '3593',
	},
...
export const submitExtrinsic22887036 = (_extrinsic: string): Promise<Hash> =>
	Promise.resolve().then(() => kusamaRegistryV1003003.createType('Hash'));

const getStorage = () => Promise.resolve().then(() => kusamaRegistryV1003003.createType('Option<Raw>', '0x00'));

const getFinalizedHead = () => Promise.resolve().then(() => blockHash789629);

export const tx22887036 = (): Extrinsic =>
	kusamaRegistryV1003003.createType('Extrinsic', balancesTransferKeepAliveValid);
 ...
 */
export const mockKusamaApiBlock26187139 = {
	runtimeVersion,
	call: {
	...
	createType: kusamaRegistryV1003003.createType.bind(kusamaRegistryV1003003),
	registry: kusamaRegistryV1003003,
	rpc: {
		chain: {
			getHeader,
			getBlock26187139,
