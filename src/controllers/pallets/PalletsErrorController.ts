 ...
 */
 export default class PalletsErrorController extends AbstractController<PalletsErrorService> {
	...
	protected initRoutes(): void {
		this.safeMountAsyncGetHandlers([
			['/:errorId', this.getErrorById as RequestHandler],
			['/', this.getErrors],
		]);
	}

	private getErrorById: RequestHandler<
		IPalletsStorageParam,
		unknown,
		unknown,
		IPalletsStorageQueryParam
