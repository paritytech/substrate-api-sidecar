...
import { kusamaCoretimeMetadata } from '../metadata/coretimeKusamaMetadata';

/**
 * Create a type registry for Asset Hub Westend.
 * Useful for creating types in order to facilitate testing.
 */
function createCoretimeKusamaRegistry(specVersion: number, metadata: `0x${string}`): TypeRegistry {
